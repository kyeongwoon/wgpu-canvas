...
import { calculate, compare } from './specificity.js';
...
describe('calculate', () => {
	[
		...
		test(`calculate("${testCase.selector}")`, () => {
...
describe('compare', () => {
	[
		...
		test(`compare("${testCase.a}", "${testCase.b}")`, () => {
...
describe('sorting with compare', () => {
	...
	test('Array.sort(compare) should sort the array by specificity', () => {
