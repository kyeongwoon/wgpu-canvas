...
import implementedProperties0 from "./implementedProperties.js";
...
const implementedProperties = Array.from(implementedProperties0).map(parsers.dashedToCamelCase);
