...
const simplename = /^[_:A-Za-z][-.:\w]+$/;
const simpleqname = /^([_A-Za-z][-.\w]+|[_A-Za-z][-.\w]+:[_A-Za-z][-.\w]+)$/;
...
// \uDB7f instead of \uDBFF.
const hassurrogates = /[\uD800-\uDB7F\uDC00-\uDFFF]/;
const surrogatechars = /[\uD800-\uDB7F\uDC00-\uDFFF]/g;
...
const surrogatename = new RegExp("^[" + namestartchars + "]" + "[" + namechars + "]*$");
const surrogateqname = new RegExp("^(" + ncname + "|" + ncname + ":" + ncname + ")$");
...
function isValidName(s) {
  ...
  const chars = s.match(surrogatechars), pairs = s.match(surrogatepairs);
